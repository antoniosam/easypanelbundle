...
use Ast\EasyPanelBundle\Lib\Crud\EasyPanelCrud;
...
class EasyPanelCrudCommand extends  ContainerAwareCommand
{
    protected function configure()
    {
        $this
            ->setName('easypanel:crud')
            ...
            ->addArgument('entity', InputArgument::REQUIRED, 'Entidad que se usara')
    ...
    protected function execute(InputInterface $input, OutputInterface $output)
    {
        ...
        $output->writeln('PanelBundle: '.$entity);
        $output->writeln('Prefix: '.$prefix);
        $output->writeln('Tipo Crud: '.$type_crud);
        $output->writeln('Ignorar: '.$ignore);
        $output->writeln('');

        $panel = new EasyPanelCrud($em,$twig,$dir,$panelbundle,$entity,$prefix,$seccion);
